...
CREATE TABLE Tasks (
    ...
    TimeLimitS DECIMAL(5,2) NOT NULL DEFAULT 2,           
    MemoryLimitKb INT NOT NULL DEFAULT 262144,
    DiskLimitKb INT NOT NULL DEFAULT 65536,
    StackLimitKb INT NOT NULL DEFAULT 8192,
