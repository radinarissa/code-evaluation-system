...
namespace CodeEvaluator.Infrastructure.Migrations
{
    ...
    [Migration("20251220155635_MoodleTaskUpsert")]
    partial class MoodleTaskUpsert
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CodeEvaluator.Domain.Entities.Submission", b =>
                {
                    ...
                    b.HasIndex("TaskId", "UserId", "AttemptNumber");

                    b.HasIndex("TaskId", "UserId", "SubmissionTime");
